...
<body>
  ...
  if(isset($_COOKIE['code_info'])) { 
    $return = $_COOKIE['code_info'];
...
<h4>Congrats <?php echo $first_name; ?>! We've applied your <?php echo $club;?> group code.</h4>
</div>
  ...
  <div class="form-container center">
    <div class="row">
      <div class="six columns">
        <h3><span class="group-price">$<?php echo $basicPrice; ?></span> <span class="og-price-small">$<?php echo $basicOGPrice; ?></span></h3>
        <ul class="no-dec">
      ...
      <div class="six columns">
        <h3><span class="group-price">$<?php echo $premiumPrice; ?></span> <span class="og-price-small">$<?php echo $premiumOGPrice; ?></span></h3>
        <ul class="no-dec">
