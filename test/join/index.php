<?php
  if (isset($_COOKIE['user'])) { 
    header ( "Location: http://test.nomful.com/payment.php" ); 
  } 
  ...
  if ( isset($_GET['a'])) {
        ...
        $refLink  = $_GET['a'];
          setcookie(
            'ref_link',		// Name of the cookie, required
            $refLink,				// The value of the cookie
            time()+60*60*24,	// Expiration time, set for a week in the future
            '/',				// Folder path the cookie will be available for
            'test.nomful.com'		// Domain to which the cookie will be bound
          );
  }
...
<body>
  ...
  <div class="container mbudge" id="bank">
    <h4 class="center">Great! Now tell us about yourself. a lot</h4>
