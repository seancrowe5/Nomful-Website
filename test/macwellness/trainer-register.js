$(function() {
	...
	// Get the form.
	var form = $('#ajax-trainer');

	// Get the messages div.
	var formMessages = $('#trainer-messages');
	...
	$(form).submit(function(e) {
        ...
        if ($('input#password').val() != $('input#retype-password').val() || $('input#password').val().length <=1 ) {
