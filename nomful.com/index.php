    ...
    <div class="row masthead-content">
      <div class="grapefruit-content">
        <div class="medium-7 medium-offset-4 columns grapefruit-content">
          ...
          <h3>All Nomful coaches are registered dietitians, with the highest level of nutrition education. You and your Nomful coach will set simple weekly goals together to achieve long-term results.</h3>
        </div>
      </div>
    </div>
  </div>
